                            ...
                            <ul className="event-list">
                                {eventsForSelectedDateRange.map((event, index) => (
                                    <li key={`${event.title}-${index}`} 
                                        ...
                                        <Button variant="link" size="sm" onClick={() => handleEditEvent(index)}>편집</Button>
                                        <Button variant="link" size="sm" onClick={() => handleDeleteEvent(index)}>삭제</Button>
                                    </li>
                                ))}
                            </ul>
                        </div>
