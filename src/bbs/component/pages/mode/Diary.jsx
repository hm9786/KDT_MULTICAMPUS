    ...
    const handleSave = async () => {
        ...
        try {
            ...
            try {
                ...
                // 주간 연속 작성 체크 (7일 연속 작성 시 50p 보너스)
    ...
    const checkWeeklyBonus = async () => {
        try {
            ...
            if (consecutiveDays === 7) {
                ...
                alert('🎉 일주일 연속 작성 보너스! 50포인트가 지급되었습니다!');
            }
        } catch (error) {
            console.error('주간 보너스 체크 중 오류:', error);
        }
    };
        ...
        <div>
            ...
            <div className={`diary-content ${isOpen ? 'sidebar-open' : ''}`}>
                <div className="diary-center">
                    ...
                    {/* 사진 첨부 */}
                    <div className="diary-padding">
                        <label className="diary-label">사진 첨부</label>
                    ...
                    {/* 별점 평가 */}
                    <div className="diary-padding">
                        <label className="diary-label">하루 정산 (별점)</label>
                    ...
                    <div className="diary-button-container">
                        ...
                        >
                            {isLoading ? '저장 중...' : existingDiary ? '수정하기' : '저장하기'}
                        </button>
                    </div>
